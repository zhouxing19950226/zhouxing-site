(() => {
  const dictionaries = {
    en: {
      ...
      'Télécharger l’application': 'Download the app', 'Télécharger': 'Download',
      'Choisissez votre téléphone. Sur Android, téléchargez le fichier APK. Sur iPhone, ouvrez l’application dans Safari puis choisissez « Ajouter à l’écran d’accueil ».': 'Choose your phone. On Android, download the APK file. On iPhone, open the app in Safari and choose “Add to Home Screen”.',
      'Télécharger pour Android': 'Download for Android', 'Installer sur iPhone': 'Install on iPhone', 'Android · APK signé · Version 1.0': 'Android · Signed APK · Version 1.0',
    ...
    zh: {
      ...
      'Télécharger l’application': '下载应用', 'Télécharger': '下载',
      'Choisissez votre téléphone. Sur Android, téléchargez le fichier APK. Sur iPhone, ouvrez l’application dans Safari puis choisissez « Ajouter à l’écran d’accueil ».': '请选择你的手机。安卓设备直接下载 APK 文件；iPhone 请在 Safari 中打开应用，然后选择“添加到主屏幕”。',
      'Télécharger pour Android': '安卓下载', 'Installer sur iPhone': '苹果安装', 'Android · APK signé · Version 1.0': 'Android · 已签名 APK · 版本 1.0',
